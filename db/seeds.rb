...
Secretarie.create!( order: 1,
                    key: "docente",
                    name: "Secretaría Docente",
                    content: [
                              "<h2>CURSOS DE FORMACIÓN EN PSICOANÁLISIS DE LAS CONFIGURACIONES VINCULARES: PAREJA, FAMILIA, GRUPO E INSTITUCIONES</h2>",
                              "<i>(Dirigido a médicos, psicólogos, psicopedagogos, trabajadores sociales y otros profesionales universitarios, terciarios y tesistas).</i>",
                              "<h3>Desarrollos programáticos:</h3>",
                              "<ul>",
                              "  <li>Psicoanálisis de las Configuraciones Vinculares.</li>",
                              "  <li>Pensamiento Contemporáneo y Subjetividad.</li>",
                              "  <li>Psicoanálisis de Familia.</li>",
                              "  <li>Psicoanálisis de Pareja.</li>",
                              "  <li>Psicoanálisis de Grupo.</li>",
                              "  <li>Análisis Institucional.</li>",
                              "</ul>",
                              "<h3>Modalidad  académica:</h3>",
                              "<p>Seis Módulos de cinco meses cada uno; frecuencia quincenal: los primeros y terceros viernes del mes de 16,30 a 20,30 hs. Modalidad presencial.</p>",
                              "<p>Clases teórico- clínicas.</p>",
                              "<p>Talleres de integración.</p>",
                              "<p>Grupos de reflexión.</p>",
                              "<p>Espacios de supervisión grupal.</p>",
                              "<p>Evaluaciones individuales y grupales al cierre de módulos.</p>",
                              "<p>Trabajo Final en grupo.</p>",
                              "<h2>Especialidad en Psiquiatría Infanto-Juvenil</h2>",
                              "<p>En convenio con la universidad Católica de Córdoba, la APCVC, a través de su equipo docente, dicta seminarios en el curso de Psiquiatría Infanto-Juvenil, que depende de la Facultad de Medicina.</p>",
                              "<h2>Reuniones del Equipo Docente</h2>",
                              "<p>Con frecuencia quincenal, los primeros y terceros viernes del mes de 10 a 12 hs. en la sede de la asociación, destinadas a la organización, debate y evaluación de las tareas docentes y como ámbito de discusión de temáticas teórico-clínicas.</p>",
                             ].join("\n"))
Secretarie.create!( order: 2,
                    key: "cientifica",
                    name: "Secretaría Científica",
                    content: [
                              "<h2>Secretaría Científica</h2>",
                              "<p>La secretaría Científica busca crear y fomentar distintas actividades que abran espacios de diálogo, de intercambio y debate.</p>",
                              "<p>Dichas actividades son tanto abiertas al  público en general como también específicas para  profesionales.</p>",
                              "<p>En la actualidad se encuentra abierto el espacio de \"Ciclo debate\", de él han participado diferentes profesionales tanto de nuestra institución como de otras.</p>",
                              "<h2>Grupos de Investigación</h2>",
                              "<h3>Grupo de Investigación en Clínica Vincular Psicoanalítica:</h3>",
                              "<ul>",
                              "  <li>Caminotti, Margarita</li>",
                              "  <li>Cejas, Ma. del Carmen</li>",
                              "  <li>Frizzo, Nilda</li>",
                              "  <li>Gaido, Graciela</li>",
                              "  <li>Ribero, Rosa</li>",
                              "</ul>",
                              "<h3>Grupo de Investigación en Teoría y Clínica de Pareja y Familia</h3>",
                              "<ul>",
                              "  <li>Gigena, María del Carmen</li>",
                              "  <li>Kowadlo, Luisa</li>",
                              "  <li>Leporati, Adriana</li>",
                              "  <li>Orortegui, Patricia</li>",
                              "  <li>Torriglia, Susana</li>",
                              "</ul>",
                              "<h4>Equipo de Pubertad y Adolescencia</h4>",
                              "<ul>",
                              "  <li>Lic. Paola Alvarez</li>",
                              "  <li>Lic. Alejandra Campanille</li>",
                              "  <li>Lic. Daniela Marini</li>",
                              "  <li>Lic. Diana Peralta</li>",
                              "  <li>Lic. Carolina Territoriale</li>",
                              "</ul>",
                             ].join("\n"))
Secretarie.create!( order: 3,
                    key: "apertura",
                    name: "Secretaría de Apertura y Asistencia a la Comunidad",
                    content: [
                              "<h3>Secretaría de Asistencia y Apertura</h3>",
                              "<p>",
                              "  El propósito de esta secretaría, es promover, afianzar y establecer vínculos con la",
                              "  comunidad, tendiendo redes intra e interinstitucionales, brindando un servicio asistencial,",
                              "  frente a demandas actuales. A su vez propone generar un ámbito que favorezca el",
                              "  desarrollo de la investigación en el campo de la clínica vincular con todos aquellos que",
                              "  desarrollen actividades abiertas a la comunidad.",
                              "</p>",
                              "<h3>¿Quiénes forman parte de esta secretaria?</h3>",
                              "<h4>Equipo de terapeutas</h4>",
                              "<ul>",
                              "  <li>Lic. Paola Alvarez</li>",
                              "  <li>Lic. Mónica Anicetto</li>",
                              "  <li>Lic. Nilda Frizzo</li>",
                              "  <li>Lic. Susana Gallardo</li>",
                              "  <li>Lic. Elsa Gautero</li>",
                              "  <li>Lic. Daniela Marini</li>",
                              "  <li>Lic. Regina Pizarro</li>",
                              "</ul>",
                              "<h4>Equipo de supervisores</h4>",
                              "<ul>",
                              "  <li>Lic. Luisa Kowadlo</li>",
                              "  <li>Dra. Lidia Lansky</li>",
                              "  <li>Lic. Susana Luraschi</li>",
                              "  <li>Dr. Daniel Spollanski</li>",
                              "</ul>",
                              "<h3>¿Qué ofrecemos?</h3>",
                              "<h4>Terapeutas</h4>",
                              "<p>",
                              "  Atención y asistencia clínica a la comunidad, en abordajes familiares, de parejas,",
                              "  grupales e individuales con honorarios reducidos.",
                              "</p>",
                              "<p>",
                              "  Se reúnen los 1º y 3º viernes de cada mes a las 15:00 hs.",
                              "</p>",
                              "<h4>Supervisores</h4>",
                              "<p>",
                              "  Supervisiones a profesionales y equipo de terapeutas de la institución.",
                              "</p>",
                              "<p>",
                              "  Supervisiones y asesoramiento a todo tipo de instituciones (públicas o privadas) o a profesionales que lo soliciten.",
                              "</p>",
                              "<p>",
                              "  Se reúnen los 3º viernes de cada mes a las 14: 00 hs.",
                              "</p>",
                              "<h4>Pubertad y Adolescencia</h4>",
                              "<p>",
                              "  Encuentros para compartir e intercambiar experiencias , saberes, interrogantes.",
                              "</p>",
                              "<p>",
                              "  Aperturas y búsquedas de nuevas herramientas de intervención que propicien la",
                              "  salud, desde lo teórico – técnico y metodológico.",
                              "</p>",
                              "<p>",
                              "  Seminarios con temática específica de púberes, adolescentes y jóvenes desde",
                              "  una perspectiva familiar, grupal, institucional, a profesionales de la salud e",
                              "  interesados en la temática.",
                              "</p>",
                              "<p>",
                              "  Contribuir desde diferentes espacios: escuelas, APCVC, otras instituciones, para",
                              "  trabajar aspectos saludables de púberes y jóvenes y sus referentes significativos.",
                              "</p>",
                              "<p>",
                              "  Atención clínica para adolescentes y su familia.",
                              "</p>",
                              "<h4>Modalidad</h4>",
                              "<p>",
                              "  Ateneos, talleres, encuentros de intercambios, etc",
                              "</p>",
                              "<p>",
                              "  Dispositivos grupales en sus diferentes modalidades, grupo tarea, grupo de",
                              "  reflexión, grupo terapéutico, grupo de padres, grupos de docentes.",
                              "</p>",
                              "<p>",
                              "  Se reúnen los 1º viernes de cada mes a las 13:15 hs.",
                              "</p>",
                             ].join("\n"))
Secretarie.create!( order: 4,
                    key: "prensa",
